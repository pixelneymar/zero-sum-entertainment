# Typography Tokens — TypeUI · Cypherpunk

> The type system for **TypeUI · Cypherpunk**. Cypherpunk pairs two voices: a clean neo-grotesque (**Untitled Sans**) carries body, controls, and most UI at a compact 14px baseline, while a retro-tech **monospace/pixel display face (Offbit)** carries the loud moments — marketing hero and display headings, and uppercase eyebrows — for a terminal, decentralized-web feel. Tight negative tracking on big headings and wide tracking on uppercase labels are part of the look. Sizes, weights, line heights, letter spacing, and family stacks are literal values and the single source of truth; components reference these tokens (and color tokens from `colors.md`), never ad-hoc type settings.
...
| Token | Value |
|---|---|
| font-family | "Untitled Sans", "Neue Haas Grotesk Display", "Helvetica Neue", Helvetica, Arial, ui-sans-serif, system-ui, sans-serif |

**Brand typeface for this design system:** a clean neo-grotesque (reference: **Untitled Sans**) for body and UI, with the retro **monospace/pixel display face** (`font-family-monospace`, reference: **Offbit**) reserved for hero/display headings and uppercase eyebrows. Load the faces in your product’s font layer; the tokens here are the stacks components reference. Substitute any comparable neo-grotesque and any pixel/retro mono face to stay stack-agnostic.
...
**Display heading rule (mandatory):** Any **big heading** — marketing hero h1, section titles, newsletter band headings, and any heading at **`font-size-5xl` (32px) or larger** — must use **`line-height-display` (1)**. Do not apply `line-height-heading` (1.3) to display-scale type; tight 1:1 leading is part of the Cypherpunk marketing look.
...
Default body tracking: **`letter-spacing-normal`**. Big display headings pull in with `letter-spacing-tighter` / `letter-spacing-tightest`; uppercase eyebrows and labels open up with `letter-spacing-wider` / `letter-spacing-widest`.
...
| Role | Family | Size (max) | Weight | Line height | Color token |
|---|---|---|---|---|---|
| hero-h1 | font-family-monospace | font-size-hero (72px) | font-weight-bold | line-height-display | `heading` |
| display | font-family-monospace | font-size-10xl (60px) | font-weight-bold | line-height-display | `heading` |
| section-heading | font-family-monospace | font-size-7xl (40px) | font-weight-semibold | line-height-display | `heading` |
| lead | font-family | font-size-lg (18px) | font-weight-normal | line-height-body | `body` |
| body | font-family | font-size-sm (14px) | font-weight-normal | line-height-body | `body` |
| overline | font-family-monospace | font-size-xs (12px) | font-weight-medium | line-height-detail (uppercase, letter-spacing-wider) | `body-subtle` |
...
| Token | Stack | When |
|---|---|---|
| font-family-monospace | "Offbit", "Departure Mono", "Berkeley Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Roboto Mono", "Courier New", monospace | Code blocks, inline code, **and the retro display voice** — hero/display headings and uppercase eyebrows |
...
```
font-family                "Untitled Sans", "Neue Haas Grotesk Display", "Helvetica Neue", Helvetica, Arial, ui-sans-serif, system-ui, sans-serif
font-family-monospace      "Offbit", "Departure Mono", "Berkeley Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Roboto Mono", "Courier New", monospace
font-size-xxs              0.6875rem   (11px)
font-size-xs               0.75rem     (12px)
font-size-sm               0.875rem    (14px)
font-size-md               1rem        (16px)
...
| Horizontal rule | — | — | — | `default` | 2px full-width divider; `spacing-8` vertical margin |
